  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Unlock a world of exam success with TestVault. Access
                    college exam papers and take practice tests online to boost
                    your performance.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground text-base sm:text-lg md:text-xl/relaxed">
                  TestVault provides you with the tools you need to excel in
                  your college exams. Access a vast library of past exam papers
                  and practice online tests to boost your confidence and
                  performance.
                </p>
              </div>
            </div>
                  ...
                  <li>
                    <div className="flex flex-col flex-wrap">
                      ...
                      <p className="text-muted-foreground text-sm sm:text-base">
                        Access a comprehensive library of past college exam
                        papers to practice and prepare.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground text-sm sm:text-base">
                        Take practice tests online to simulate the real exam
              ...
              <div className="flex flex-col justify-center space-y-4 w-full">
                <div className="rounded-lg bg-card p-6 shadow-sm">
                  ...
                  <p className="mt-4 text-muted-foreground">
                    &quot;TestVault has been a game-changer for me. The access
                    to past exam papers and the online practice tests have
                    significantly improved my exam performance.&quot;
                  </p>
                </div>
                <div className="rounded-lg bg-card p-6 shadow-sm">
                  <div className="flex items-center space-x-4">
                  ...
                  <p className="mt-4 text-muted-foreground">
                    &quot;I highly recommend TestVault to any student looking to
                    improve their exam scores. The platform is user-friendly and
          ...
          <div className="container px-4 sm:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground text-base sm:text-lg md:text-xl/relaxed">
                  TestVault&aposs online exam feature provides a realistic
                  simulation of the real exam experience, helping you identify
                ...
                <ul className="grid gap-6">
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground text-sm sm:text-base">
                        Take practice tests under timed conditions to simulate
                  ...
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground text-sm sm:text-base">
                        Receive comprehensive feedback on your performance,
                  ...
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground text-sm sm:text-base">
                        The online exams adjust in difficulty to challenge you
                        and help you grow.
                      </p>
                    </div>
                  </li>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">
          &copy; 2024 TestVault. All rights reserved.
        </p>
